										...
										<div class="slider_recipe">
											<div class="modal-body">
												<div class="sec_detail">
													<div id="carousel-thumb"
														...
														<div class="carousel-inner">
															<div class="carousel-item active">
																<img
																	src="<%=request.getContextPath()%>/uploadRcpFile/${rcpContent.thumbnail}"
																	class="d-block w-100" alt="...">
															</div>
															<c:forEach var="rcpContent2" items="${rcpContent2}">
																<div class="carousel-item">
																	<img
																		src="<%=request.getContextPath()%>/uploadRcpContentFile/${rcpContent2.fileName}"
																		class="d-block w-100" alt="...">
																</div>
															</c:forEach>
														</div>
														...
														<ol class="carousel-indicators">
															<li data-target="#carousel-thumb" data-slide-to="0"
																class="active"><img class="d-block w-100"
																src="<%=request.getContextPath()%>/uploadRcpFile/${rcpContent.thumbnail}"
																class="img-fluid"></li>
															<c:forEach var="rcpContent2" items="${rcpContent2}"
																varStatus="status">
																<li data-target="#carousel-thumb"
																	data-slide-to="${status.count}"><img
																	class="d-block w-100"
																	src="<%=request.getContextPath()%>/uploadRcpContentFile/${rcpContent2.fileName}"
																	class="img-fluid"></li>
															</c:forEach>
													...
													<h2>
														영양정보<span>(하루 적정섭취량, 1인분 기준)</span>
													</h2>
													<h2>태그 정보</h2>
													<h2>레시피 정보</h2>
													<ol class="lst_step">
													...
													<ul class="lst_comment">
														<li>
															<div class="img-cover">
																<img
																	src="<%=request.getContextPath()%>/uploadFile/profile.png">
															</div> <strong>Test</strong> <time>2015.02.02</time>
															<p>Good</p>
														</li>
													</ul>
													</section>
												...
												<div class="aside">
													<div class="top">
														<div class="user">
															<div class="img-cover">
																<a
																	href="<%=request.getContextPath()%>/member/mypage?memNum=${rcpContent.memnum}">
																	<img class="img_user"
																	src="<%=request.getContextPath()%>/uploadFile/${rcpContent.profile}">
																</a>
															</div>
															<strong class="best"><a
																href="<%=request.getContextPath()%>/member/mypage?memNum=${rcpContent.memnum}">${rcpContent.name}</a></strong>
														</div>
														...
														<!-- 내가 쓴 글인 지 아닌 지 확인 -->
															<c:if test="${loginNum!=rcpContent.memnum}">
																<c:if test="${checkScrap==0}">
																	<form
																		action="<%=request.getContextPath()%>/member/scrap"
																		method="post">
																		<input type="hidden" name="scrapnum"
																			value="${rcpContent.rcpnum}">
																		<button type="submit" class="btn_scrap">
																...
																<c:if test="${checkScrap==1}">
																	<form
																		action="<%=request.getContextPath()%>/member/delScrap"
																		method="post">
																		<input type="hidden" name="scrapnum"
																			value="${rcpContent.rcpnum}">
																		<button type="submit" class="btn_scrap">
																...
																<!-- 좋아요 버튼 영역 추가 for my lovely heart -->
														...
														<div class="btn_area">
															<form action="<%=request.getContextPath()%>/rcp/cancelLike"
																...
																<!-- if(rcpnum == loginNum) {
																	...
																	System.out.println("다른 사람이 쓴 글");
																} -->
																
													<div class="btm"
														style="position: relative; top: 0px; left: 0px; margin-left: 0px;">
														<h2>재료리스트</h2>
														<div class="dropdown">1인 기준</div>
